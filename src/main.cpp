...
#include "Atom/beryllium.hpp"
#include "Atom/helium.hpp"
...
int main() {
    ...
    auto He = Helium_6311G2df2pd();
    auto Be = Beryllium_STO6G();
    auto Be2 = Beryllium_631ppGss();

    RestrictedHartreeFock hf(Be2, 4);
    hf.set_smoothing_factor(0.3);
    hf.set_diis_size(0);
    hf.run(1e-8, 100000, 1, false);
    return 0;
};