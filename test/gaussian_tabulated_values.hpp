...
inline Eigen::MatrixXd setupExactOverlapMatrix() {
    auto m_exactOverlap = Eigen::MatrixXd(10, 10);
    ...
    return m_exactOverlap;
}

inline Eigen::MatrixXd setupExactKineticMatrix() {
    auto m_exactKinetic = Eigen::MatrixXd(10, 10);
    ...
    return m_exactKinetic;
}

inline Eigen::MatrixXd setupExactElectronNucleusMatrix() {
    auto m_exactElectronNucleus = Eigen::MatrixXd(10, 10);
    ...
    return m_exactElectronNucleus;
}

inline Eigen::MatrixXd setupExactElectronElectronVector() {
    auto m_exactElectronElectron = Eigen::VectorXd(10);
    ...
    return m_exactElectronElectron;
}