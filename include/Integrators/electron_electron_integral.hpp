...
double electron_electron_integral(const ContractedOrbital<OrbitalType>& orbital1,
                                const ContractedOrbital<OrbitalType>& orbital2,
                                const ContractedOrbital<OrbitalType>& orbital3,
                                const ContractedOrbital<OrbitalType>& orbital4) {
    double integral = 0.0;
