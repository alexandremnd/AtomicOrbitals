...
#include "Orbitals/contracted_orbital.interface.hpp" // IWYU pragma: export
...
ContractedOrbital<PrimitiveType>::ContractedOrbital(
    std::vector<double> &coefficients, std::vector<PrimitiveType> &primitives)
    : m_coefficients(coefficients), m_primitives(primitives) {
    if (coefficients.size() != primitives.size()) {
        throw std::length_error("ContractedOrbital: The number of coefficients "
...
template <DerivedFromOrbital PrimitiveType>
void ContractedOrbital<PrimitiveType>::add_primitive(
...
template <DerivedFromOrbital PrimitiveType>
inline const PrimitiveType &
ContractedOrbital<PrimitiveType>::get_primitive(int i) const {
...
template <DerivedFromOrbital PrimitiveType>
double overlap_integral(const ContractedOrbital<PrimitiveType> &orbital1,
...
template <DerivedFromOrbital PrimitiveType>
double
electron_nucleus_integral(const ContractedOrbital<PrimitiveType> &orbital1,
                          const ContractedOrbital<PrimitiveType> &orbital2,
...
template <DerivedFromOrbital PrimitiveType>
double
electron_electron_integral(const ContractedOrbital<PrimitiveType> &orbital1,
                           const ContractedOrbital<PrimitiveType> &orbital2,
